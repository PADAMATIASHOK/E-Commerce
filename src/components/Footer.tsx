    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4">Flipkart</h3>
            <p className="text-gray-400 mb-4">
              India's leading e-commerce platform offering a wide range of products at competitive prices.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Flipkart Stories</a></li>
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors">Flipkart Wholesale</a></li>
            </ul>
          </div>
